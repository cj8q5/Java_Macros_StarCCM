...
public class TimeStepVariationStudy extends StarMacro 
{
	double[] m_timeStep = new double[1];
	...
	public void execute() 
	{
		...
		for (int i = 0; i < m_timeStep.length; i++)
		{
			...
			activeSim.saveState(currentDirectory + File.separator + "SS_Deflection_TS_" + Double.toString(timeStep));
			activeSim.close();
		}
	}
