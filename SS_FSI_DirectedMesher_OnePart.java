...
public class SS_FSI_DirectedMesher_OnePart extends StarMacro 
{
	...
	public void execute() 
	{
		...
		reader.readGeometryData(folder + "Plate_Geometry_Input_v2.txt");
		...
		stoppingCriteria.innerIterationStoppingCriteriaController(25000, "OR", false);
		...
		LinePart smChLinePart = smChLineProbe.createLineProbe(lgChLineProbeCoord_0, lgChLineProbeCoord_1, 255, "LargeChannelLineProbe");
		...
		LinePart lgChLinePart = lgChLineProbe.createLineProbe(smChLineProbeCoord_0, smChLineProbeCoord_1, 255, "SmallChannelLineProbe");
